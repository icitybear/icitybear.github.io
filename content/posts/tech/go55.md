...
import (
	...
	"git.internal.taqu.cn/go-modules/kratos-extends/httpclient"
	prom "github.com/go-kratos/kratos/contrib/metrics/prometheus/v2"
	"github.com/go-kratos/kratos/v2/metrics"
...
sum(pulsar_subscription_back_log{cluster="taqu-online-pulsar", namespace="middle_tenant/mp_ns", topic=~"persistent://middle_tenant/mp_ns/admp_material_supplement-partition-.+"})
```
