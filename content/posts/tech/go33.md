---
title: "Go包(package), 库, 模块(module)" #标题
...
注意点:
1. go module 模块名称规范要求路径的第一部分必须满足域名规，<font color="red">gitlab(公司)与github等域名</font>
...
- https://github.com/satori/go.uuid 无go.mod
![](image5.png)
...
- go.mod的文件内容   module  github.com/langwan/go-jwt-hs256  
![](image1.png)

无下级目录(整个module就一个package包)，直接是xxx.go文件（package jwt与文件名一致）可以直接用
import "github.com/langwan/go-jwt-hs256"
jwt.Xxx()
