...
## 基于切片
- 基于切片，本质也是基于数组
- slice[start:end],<font color="red"> 左闭右开的集合, end必须确保基础切片本身长度>=end </font>
``` go
...
- <font color="red">标准库sort</font>，这个包提供了一系列对切片和用户自定义集合进行排序的函数。
  - sort.Slice(slice, func(i, j int) bool)
  - 自定义规则Len,Less,Swap和sort.Reverse 的作用 它包装原始结构体，反转 Less() 方法的逻辑
...
func TestSliceSort(t *testing.T) {
	...
	sort.Sort(a)
	fmt.Println(a) // [78 45 33 14 12 9]
}
...
func TestSliceSort2(t *testing.T) {
	...
	fmt.Println(p) // [{mike 14} {jane 13} {peter 12}]
}
