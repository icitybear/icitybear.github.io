...
- 重写外键, foreignKey 配合预加载
 - [实体关联](https://learnku.com/docs/gorm/v2/associations/9740)
 - [preload预加载](https://learnku.com/docs/gorm/v2/preload/9741#012e7e)
![alt text](image9.png)
## 指定表名
``` go
...
3. Updates+Map, **<font color="red">Updates的参数不使用结构体，使用map[string]any </font> **
...
- 确保在传递给 DoUpdates 方法的记录中<font color="red">包含了唯一键字段（ID 或其他你定义的联合唯一键）</font>, 如果设置非主键字段就会每次都是新增
``` go
// 冲突时忽略
