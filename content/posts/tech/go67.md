...
[Go单元测试综合指南](https://tech.qimao.com/dan-yuan-ce-shi/)

# <font color="red">单元测试工具包</font>
- github.com/stretchr/testify 包括简单的断言和创建模拟对象的机制 assert断言库 mock模拟框架 suite测试套件支持
- github.com/alecthomas/assert/v2 专注断言 完全支持泛型
- github.com/cweill/gotest 生成单元测试代码 go1.22 idea插件
